    ...
    public class CarouselControllerTests
    {
        ...
        public async Task CarouselCreate_ValidSuccess()
        {
            ...
            */
            ...
            int carouselCount = (await databaseContext.CarouselItem.ToListAsync()).Count;
            Assert.Equal(1, carouselCount);

            Assert.Single(await databaseContext.CarouselItem.ToListAsync());
